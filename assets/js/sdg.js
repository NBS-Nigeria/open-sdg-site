...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses, allObservationAttributes) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"subfolder":"country","label":"Nigeria","min_zoom":5,"max_zoom":10,"staticBorders":false},{"subfolder":"regions","label":"Zones","min_zoom":5,"max_zoom":10,"staticBorders":false},{"subfolder":"state","label":"States","min_zoom":5,"max_zoom":10,"staticBorders":false}],
      precision: precision,
