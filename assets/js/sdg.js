...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses, allObservationAttributes) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"subfolder":"country","label":"Nigeria","min_zoom":4,"max_zoom":6,"staticBorders":true},{"subfolder":"regions","label":"Zones","min_zoom":6,"max_zoom":8,"staticBorders":true},{"subfolder":"states","label":"States","min_zoom":9,"max_zoom":12,"staticBorders":true}],
      precision: precision,
